	...
	<div class="mt-5">
		<div class="container">
			...
			<div class="form-group row mt-5">
				...
				<div class="col-sm-3">
					<input type="text" id="movie_id" name="movie_id" 
						class="form-control" value="<%=rs.getString("movie_id") %>">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="title" name="title" 
						class="form-control" value="<%=rs.getString("title") %>">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="director" name="director" 
						class="form-control" value="<%=rs.getString("director") %>">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="actor" name="actor" 
						class="form-control" value="<%=rs.getString("actor") %>">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="runningtime_m" name="runningtime_m" 
						class="form-control" value="<%=rs.getString("runningtime_m") %>">
				</div>
			</div>
			<div class="form-group row">
